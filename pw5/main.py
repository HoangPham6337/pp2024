...
import_data(courses, students, marks)
...
if use_old_ui:
    ...
    while True:
        ...
        if exitCode == "exit":
            break
export_courses(courseList=courses)
export_students(studentList=students)
export_marks(markList=marks)
compress_data(courses, students, marks)